...
Author: Diogo Araújo
Version: 1.0
E-mail: daraujo.augusto@gmail.com
*/
...
string retornaPalavraAleatoria(){
    ...
    string palavras[21] = {"abacaxi","abacate", "acerola", "amora", "banana", "cacau", "cereja", "coco", "goiaba", "jabuticaba",
                        "jambo", "jaca", "kiwi", "laranja", "melancia", "manga", "morango", "pera", "pitanga", "tangerina", "uva"};

    //Indice gerado no intervalo {0-21}
